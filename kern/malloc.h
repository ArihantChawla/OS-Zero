...
#include <kern/mem/mem.h>
#define  kwalloc(nb)   memalloc(nb, MEMWIREDBIT)
#define  kmalloc(nb)   memalloc(nb, 0)
#define  kcalloc(nb)   memalloc(nb, MEMZEROBIT)
#define  kcwalloc(nb)  memalloc(nb, MEMZEROBIT | MEMWIREDBIT)
#define  kvalloc(nb)   memalloc(PAGESIZE, 0)
#define  kcvalloc(nb)  memalloc(PAGESIZE, MEMZEROBIT)
#define  kcvwalloc(nb) memalloc(PAGESIZE, MEMZEROBIT | MEMWIREDBIT)
