...
$AS -mno-red-zone -Wno-unused -Wundef -Wextra -DZEROMTX=1 -D_ZERO_SOURCE=1 -DNEWSIGNAL=1 -DNEWMP=1 -DNEWTMR=1 -DFASTINTR=1 -DNEWCLI=1 -DQEMU=1 -g -D__KERNEL__=1 -D__MTKERNEL__ -march=pentium-mmx -fno-builtin -finline-functions -ffreestanding -static -Wall -I../../.. -I../../../usr/lib -I../../../usr/lib/c -g -m32 -O0 -fno-omit-frame-pointer -fno-stack-protector -msse -c ../x86/boot.S *.S
