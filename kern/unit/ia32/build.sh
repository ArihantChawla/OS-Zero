...
./clean.sh
$CC $CFLAGS -mno-red-zone $CCWARNFLAGS -Wno-unused -D__ZEROLIBC__=1 -D_ZERO_SOURCE=1 -DNEWSIGNAL=1 -DNEWMP=1 -DNEWTMR=1 -DFASTINTR=1 -DNEWCLI=1 -DKLUDGE=1 -DMEMTEST=0 -D_REENTRANT=1 -DQEMU=1 -g -DKERN32BIT=1 -D__KERNEL__=1 -D__MTKERNEL__ -march=pentium-mmx -m32 -fno-asynchronous-unwind-tables -ffreestanding -static -I../../../usr/lib -I../../../usr/lib -I../../.. -I../../../usr/lib/c -O -fno-omit-frame-pointer -c ../../../usr/lib/zero/hash.c *.c ../../*.c ../x86/*.c ../../proc/*.c ../../mem/*.c ../../io/*.c ../../io/drv/chr/cons.c ../../io/drv/pc/*.c ../../math/i387/math.c ../../../usr/contrib/Zeno/plasma24grid.c ../../../usr/lib/zero/fastudiv.c 
#../../../usr/lib/zero/randlfg2.c ../../../usr/lib/zero/randmt32.c ../../../usr/lib/zero/x86/cpuid.c
$AS $CFLAGS -mno-red-zone -DZEROMTX=1 -D_ZERO_SOURCE=1 -DNEWSIGNAL=1 -DNEWMP=1 -DNEWTMR=1 -DNEWCLI=1 -DQEMU=1 -g -D__ZEROKERNEL___=1 -D__KERNEL__=1 -D__MTKERNEL__ -march=pentium-mmx -ffreestanding -static -I../../.. -I../../../usr/lib -I../../../usr/lib/c/include -I../../../usr/lib/c -I../../../usr/lib/c/zlibc -m32 -O -fno-omit-frame-pointer -msse -c ../x86/boot.S *.S
