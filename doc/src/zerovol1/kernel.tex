...
\chapter{Preface}
	...
	requirements and possibilities. I think it's worth designing a new
	operating system for modern computers.
...
\begin{tabular}{ | l | l | l | l | }
	...
	\hline
	THR\_NEW     & class & struct thrarg *  & pthread\_create() \\
	\hline
	THR\_JOIN    & thrid & struct thrjoin * & pthread\_join() \\
	\hline
	THR\_DETACH  & N/A   & N/A              & pthread\_detach() \\
	\hline
	THR\_EXIT    & N/A   & N/A              & pthread\_exit() \\
	\hline
	THR\_CLEANUP & N/A   & N/A              & cleanup; pop and execute handlers etc. \\
	\hline
	THR\_KEYOP   & cmd   & struct thrkeyop * & create, delete \\
	\hline
	THR\_SYSOP   & cmd   & struct thrsys *  & atfork, sigmask, sched, scope \\
	\hline
	THR\_STKOP   & thrid & struct thrstk *  & stack; addr, size, guardsize \\
	\hline
	THR\_RTOP    & thrid & struct thrrtop * & realtime thread settings \\
	\hline
	THR\_SETATTR & thrid & struc thrattr *  & set other attributes \\
	\hline
\end{tabular}
...
\begin{tabular}{ | l | l | l | l | }
	...
	\textbf{cmd}    & \textbf{parm} & \textbf{arg} & notes \\
	\hline
	PROC\_GETPID    & N/A           & N/A & getpid() \\
	\hline
	PROC\_GETPGRP   & N/A           & N/A & getpgrp() \\
	\hline
	PROC\_WAIT      & procid        & N/A & wait() \\
	                & PROC\_WAITPID & N/A & wait for pid \\
                        & PROC\_WAITCLD & N/A & wait for children in the group pid \\
	                & PROC\_WAITGRP & N/A & wait for children in the group of caller \\
	                & PROC\_WAITANY & N/A & wait for any child process \\
	\hline
	PROC\_USLEEP    & milliseconds  & N/A & usleep() \\
	\hline
	PROC\_NANOSLEEP & nanoseconds   & N/A & nanosleep() \\
	\hline
\end{tabular}
...
\begin{tabular}{ | l | l | l | l | }
	...
	cmd          & parm    & arg             & notes \\
	\hline
	SIG\_WAIT    & N/A     & N/A             & pause() \\
	\hline
	SIG\_SETFUNC & sig     & struct sigarg * & signal()/sigaction() \\
	\hline
	SIG\_SETMASK & N/A     & sigset\_t *     & sigsetmask() \\
	\hline
	SIG\_SEND    & N/A     & sigset\_t *     & raise() etc. \\
	\hline
	SIG\_SETSTK  & N/A     & struct sigstk * & sigaltstack() \\
	\hline
	SIG\_SUSPEND & N/A     & sigset\_t *     & sigsuspend(), sigpause() \\
	\hline
\end{tabular}
