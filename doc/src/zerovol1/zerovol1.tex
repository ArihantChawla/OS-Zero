...
\section{GRUB Support}
	...
	\textbf{kern/ia32/boot.h} which shows the multiboot header and
	parameters in C syntax (see \textbf{struct mboothdr}).

\newpage

	\textbf{kern/ia32/boot.h}

\VerbatimInput{../../../kern/ia32/boot.h}
...
\newpage
	...
	\textbf{kern/ia32/boot.S}

\VerbatimInput{../../../kern/ia32/boot.S}
...
\section{System Initialisation}
	...
	The following code is \textbf{kern/ia32/setup.S}, which implements
	...
	\textbf{kern/ia32/setup.S}

\VerbatimInput{../../../kern/ia32/setup.S}
...
\subsection{Interrupt Initialisation}
	...
	\textbf{kern/ia32/trap.c} and activated in \textbf{kern/ia32/setup.S}.

	\textbf{kern/ia32/trap.c}

\VerbatimInput{../../../kern/ia32/trap.c}

	\textbf{idtset()}

	Our interrupt vector is enabled with the \textbf{idtset} function in
	\textbf{kern/ia32/setup.S} shown earlier in this chapter.
...
\section{Multiprocessor Bootstrap}
	...
	\textbf{kern/ia32/mpentry.S}

\VerbatimInput{../../../kern/ia32/mpentry.S}
...
\section{Linker Script}
	...
	\textbf{kern/ia32/kern.lds}

\VerbatimInput{../../../kern/ia32/kern.lds}
...
\VerbatimInput{../../../kern/ia32/pit.h}

\newpage

	The following code implements our PIT initialisation.

\VerbatimInput{../../../kern/ia32/pit.c}
...
\subsection{Page Structures}
	...
	The page directory is declared in \textbf{kern/ia32/boot.S}. It's just
	a single page of physical memory identity-mapped at the same virtual as
	physical address. A single page directory entry points to the page
	directory itself, creating a recursion when looking for page addresses.
...
\subsection{Memory Interface}
	...
	\textbf{kern/ia32/vm.h}

\VerbatimInput{../../../kern/ia32/vm.h}
...
\section{DMA Interface}
	...
	\textbf{kern/ia32/dma.h}

\VerbatimInput{../../../kern/ia32/dma.h}
