...
//    long              lim = n + (n & 0x01);
    ...
    while (num < lim) {
        ...
        room1 = tab[ndx];
        mjolsplitroom(room1);
        tab[ndx1] = room1->part1;
        tab[ndx2] = room1->part2;
        room1->part1->parent = room1;
        room1->part2->parent = room1;
        num++;
        ndx++;
        ndx1 += 2;
        ndx2 += 2;
