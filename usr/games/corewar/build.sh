...
gcc $CCWARNFLAGS -I../../lib -I.. -O -o cw cw.c rc.c ../../lib/zero/randmt32.c -pthread
gcc $CCWARNFLAGS -DZEUS=1 -I../../lib -I.. -O -g -o zeus cw.c rc.c zeus.c x11.c ../../lib/zero/randmt32.c -lX11 -lImlib2 -pthread
