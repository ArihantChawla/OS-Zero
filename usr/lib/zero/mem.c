...
void *
memgetbufblk(struct membuf *head, volatile struct membkt *bkt,
             MEMUWORD_T size, MEMUWORD_T align)
{
    void          *ptr = NULL;
...
void
memdequeuebuf(struct membuf *buf, volatile struct membkt *src)
{
    struct membuf *head;
    MEMADR_T       upval;
