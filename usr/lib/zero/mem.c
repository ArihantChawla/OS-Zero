...
MEMPTR_T
memgetblktls(MEMWORD_T type, MEMWORD_T slot, MEMUWORD_T size, MEMUWORD_T align)
{
...
MEMPTR_T
memgetblkglob(MEMWORD_T type, MEMWORD_T slot, MEMUWORD_T size, MEMUWORD_T align)
{
    volatile struct membkt *bkt;
    struct membuf          *head;
    MEMPTR_T                ptr;
