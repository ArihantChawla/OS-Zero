...
pthread_mutex_t     randmt32mtx = PTHREAD_MUTEX_INITIALIZE#if 0
ZERO_MUTEX_TYPE     randmt32initmtx = ZERO_FMTX_INITIALIZER;
ZERO_MUTEX_TYPE     randmt32mtx = ZERO_FMTX_INITIALIZER;
