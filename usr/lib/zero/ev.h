 ...
 */
#define EV_NO_EVENT_BIT              0
#define EV_KEY_PRESS_BIT             (1L << 0)
#define EV_KEY_RELEASE_BIT           (1L << 1)
#define EV_BUTTON_PRESS_BIT          (1L << 2)
#define EV_BUTTON_RELEASE_BIT        (1L << 3)
#define EV_POINTER_MOTION_BIT        (1L << 6)
#define EV_POINTER_MOTION_HINT_BIT   (1L << 7)
#define EV_BUTTON_MOTION_BIT         (1L << 8)
#define EV_ENTER_WINDOW_BIT          (1L << 4)
#define EV_LEAVE_WINDOW_BIT          (1L << 5)
#define EV_KEYMAP_STATE_BIT          (1L << 9)
#define EV_EXPOSURE_BIT              (1L << 10)
#define EV_VISIBILITY_CHANGE_BIT     (1L << 11)
#define EV_STRUCTURE_NOTIFY_BIT      (1L << 12)
#define EV_RESIZE_REDIRECT_BIT       (1L << 13)
#define EV_SUBSTRUCTURE_NOTIFY_BIT   (1L << 14)
#define EV_SUBSTRUCTURE_REDIRECT_BIT (1L << 15)
#define EV_FOCUS_CHANGE_BIT          (1L << 16)
#define EV_PROPERTY_CHANGE_BIT       (1L << 17)
#define EV_COLORMAP_CHANGE_BIT       (1L << 18)
#define EV_OWNER_GRAB_BUTTON_BIT     (1L << 19)
