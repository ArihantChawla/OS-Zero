...
$CC -Wundef -Wextra -D_REENTRANT=1 -DZEROMTX=1 -DSHUNTC=1 -DNVALGRIND -DZEROMTX=1 -DZEROMALLOC=0 -DPTHREAD=1 -DZEROTHR=1 -g -Wall -O -I.. -fPIC -shared -o zerolib.so *.c -pthread
