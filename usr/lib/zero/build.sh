...
CC=gcc
CCBUILDFLAGS="-D_REENTRANT=1 -D_ZERO_SOURCE=1 -D_GNU_SOURCE=1 -DZEROCOND=1 -DSHUNTC=1 -DNVALGRIND -DZEROTHR=1 -DMEMMULTITAB=0 -DMEMNEWHASH=1 -DMEMLFHASH=1 -msse2"
#CC=clang
...
$CC $CCBUILDFLAGS $CCWARNFLAGS -g -O -I.. -fPIC -shared -o zerolib.so *.c x86-64/*.c x86-64/*.S -pthread
