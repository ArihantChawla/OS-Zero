...
#define __SCHED_OTHER_PRIO_MIN SCHEDUSERPRIOMIN
#define __SCHED_OTHER_PRIO_MAX SCHEDUSERPRIOMAX
#define __SCHED_FIFO_PRIO_MIN  (-SCHEDNCLASSPRIO + 1)
#define __SCHED_FIFO_PRIO_MAX  0
#define __SCHED_RR_PRIO_MIN    0
#define __SCHED_RR_PRIO_MAX    (SCHEDNCLASSPRIO - 1)
