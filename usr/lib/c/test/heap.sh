...
$CC $CCWARNFLAGS -DX11VIS=0 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -g -Wall -fno-builtin -DZEROTHR=0 -O -fno-omit-frame-pointer -I../../../.. -I../../../lib -o zheap ../_string.c heap.c ../../zero/lfq.c ../../zero/hash64.c ../../zero/priolk.c ../malloc.c -pthread
...
$CC $CCWARNFLAGS -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -fno-builtin -O -fno-omit-frame-pointer -I../../../.. -I../../../lib -o xzheap ../_string.c heap.c ../../zero/lfq.c ../../zero/hash64.c ../../zero/priolk.c ../malloc.c -Wl,-lX11 -pthread
$CC $CCWARNFLAGS -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -fno-builtin -O -fno-omit-frame-pointer -I../../../.. -I../../../lib -o t-test1 ../_string.c ../../zero/lfq.c ../../zero/hash64.c ../../zero/priolk.c ../malloc.c t-test1.c -Wl,-lX11 -pthread
$CC $CCWARNFLAGS -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -fno-builtin -O -fno-omit-frame-pointer -I../../../.. -I../../../lib -o tmem ../_string.c ../../zero/lfq.c ../../zero/hash64.c ../../zero/priolk.c ../malloc.c tmem.c -Wl,-lX11 -pthread
...
$CC $CCWARNFLAGS -DX11VIS=0 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DDEVEL=0 -g -Wall -fno-builtin -shared -fPIC -O -fno-omit-frame-pointer -I../../../.. -I../../../lib -fPIC -shared -o zmalloc.so ../_string.c ../../zero/lfq.c ../../zero/hash64.c ../../zero/priolk.c ../malloc.c -pthread
