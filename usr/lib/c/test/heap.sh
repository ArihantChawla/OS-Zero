...
CCOPTFLAGS="-DMEMDEBUGDEADLOCK=0 -DMEMINITBUFFIXED=1 -DMEMMULTITAB=0 -DMEMBIGHASHTAB=0 -DMEMHASHLOCK=0 -DMEMNEWHASH=1 -DMEMBITFIELD=0 -DMEMSTAT=0 -DMEMDEBUG=1 -DMEMDEBUGLOCK=0 -DMEMTEST=0 -DMEMVALGRIND=1 -O0 -fno-builtin" # -fno-tree-loop-distribute-patterns -fno-omit-frame-pointer"
