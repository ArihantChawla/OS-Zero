...
CC=gcc
CCFLAGS=""
CCOPTFLAGS="-DMEMHASHLOCK=0 -DMEMNEWHASH=1 -DMEMBITFIELD=0 -DMEMSTAT=0 -DMEMDEBUG=0 -DMEMDEBUGLOCK=0 -DMEMTEST=1 -DMEMHASHLOOP=0 -DMEMBIGARRAYHASH=0 -DMEMARRAYHASH=0 -DMEMHASH=0 -DMEMHUGELOCK=1 -DMEMMULTITAB=0 -DMEMVALGRIND=1 -O0 -fno-builtin" # -fno-tree-loop-distribute-patterns -fno-omit-frame-pointer"
