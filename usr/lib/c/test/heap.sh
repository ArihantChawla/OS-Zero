...
CC=gcc
CCOPTFLAGS="-DMEMPAGEBIN=1 -DMEMVALGRIND=1 -O -fno-builtin" # -fno-tree-loop-distribute-patterns -fno-omit-frame-pointer"
...
$CC $CCOPTFLAGS $CCWARNFLAGS -DMALLOCSTAT=0 -DMALLOCHASHSTAT=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -I../.. -I../../../.. -I../../../lib -o xzheap heap.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c  ../../zero/mem.c ../malloc.c -Wl,-lX11 -pthread
$CC $CCOPTFLAGS $CCWARNFLAGS -DMALLOCSTAT=0 -DMALLOCHASHSTAT=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -I../.. -I../../../.. -I../../../lib -o t-test1 ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c  ../../zero/mem.c ../malloc.c t-test1.c -Wl,-lX11 -pthread
$CC $CCOPTFLAGS $CCWARNFLAGS -DMALLOCSTAT=0 -DMALLOCHASHSTAT=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -I../.. -I../../../.. -I../../../lib -o tmem ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c  ../../zero/mem.c ../malloc.c tmem.c -Wl,-lX11 -pthread
...
$CC $CCOPTFLAGS $CCWARNFLAGS -DX11VIS=0 -DMALLOCSTAT=0 -DMALLOCHASHSTAT=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DDEVEL=0 -g -Wall -fno-builtin -fno-tree-loop-distribute-patterns -shared -fPIC -I../../../.. -I../../../lib -fPIC -shared -o zmalloc.so -I../.. ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c ../../zero/mem.c ../malloc.c -pthread
