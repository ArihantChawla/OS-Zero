...
$CC $CCWARNFLAGS -DX11VIS=0 -DMALLOCMULTITAB=1 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DDEVEL=0 -g -Wall -fno-builtin -shared -fPIC -O -I../../../.. -I../../../lib -fPIC -shared -o zmalloc.so ../malloc.c -pthread
