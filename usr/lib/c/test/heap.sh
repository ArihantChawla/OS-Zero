...
CCOPTFLAGS="-O -fno-builtin -DMEMMAPSTACK=1 -DMEMNEWHDR=1 -DMEMMAPHDR=1 -DMEMSIGNAL=0 -DMEMBIGHASH=0 -DMEMSTAT=1 -DMEMBUFDEBUG=0 -DMEMHASHSUBTABS=1 -DMEMBIGPAGES=0 -DMEMUNMAP=1 -DMEMEMPTYTLS=1 -DMEMDEADBINS=0 -DMEMCACHECOLOR=0 -DMEMBUFSTACK=0 -DMEMBUFRELMAP=1 -DMEMDYNTLS=1 -DMEMNEWHASHTAB=0 -DMEMNOSBRK=1 -DGNUMALLOC=0 -DMEMHASHMURMUR=0 -DMEMHASHNREF=0 -DMEMHASHNACT=0 -DMEMDEBUGDEADLOCK=0 -DMEMMULTITAB=0 -DMEMTINYHASHTAB=1 -DMEMSMALLHASHTAB=0 -DMEMHUGEHASHTAB=0 -DMEMBIGHASHTAB=0 -DMEMNEWHASH=1 -DMEMBITFIELD=0 -DMEMDEBUG=1 -DMEMDEBUGLOCK=0 -DMEMTEST=0 -DMEMTESTSTACK=0 -DMEMVALGRIND=1 -finline-functions -fno-builtin-memset -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-free -fno-builtin-realloc -fno-builtin-memalign"
