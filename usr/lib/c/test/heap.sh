...
$CC -D_ZERO_SOURCE=1 -D_REENTRANT -g -Wall -O -I../.. -o zheap heap.c ../malloc.c -pthread
...
$CC -D_ZERO_SOURCE=1 -D_REENTRANT -DDEVEL=0 -g -Wall -O0 -I../.. -fPIC -shared -o zmalloc.so ../malloc.c -pthread
$CC -D_ZERO_SOURCE=1 -D_REENTRANT -DX11VIS=1 -DEVEL=0 -g -Wall -O -I../.. -fPIC -shared -o xzmalloc.so ../malloc.c -lX11 -pthread
