...
$CC $CCWARNFLAGS -msse2 -DX11VIS=0 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -g -Wall -fno-builtin -DZEROTHR=0 -O -fno-omit-frame-pointer -I../.. -I../../../.. -I../../../lib -o zheap ../_string.c heap.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c  ../malloc.c -pthread
#$CC $CCWARNFLAGS -msse2 -DX11VIS=0 -DMALLOCTRACE=1 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -g -Wall -fno-builtin -O -fno-omit-frame-pointer -I../../../.. -I../../../lib -o tzheap heap.c ../execinfo.c ../../zero/priolk.c ../../zero/lfdeq.c  ../malloc.c -pthread
$CC $CCWARNFLAGS -msse2 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -fno-builtin -O -fno-omit-frame-pointer -I../.. -I../../../.. -I../../../lib -o xzheap ../_string.c heap.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c  ../malloc.c -Wl,-lX11 -pthread
$CC $CCWARNFLAGS -msse2 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -fno-builtin -O -fno-omit-frame-pointer -I../.. -I../../../.. -I../../../lib -o t-test1 ../_string.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c  ../malloc.c t-test1.c -Wl,-lX11 -pthread
$CC $CCWARNFLAGS -msse2 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -fno-builtin -O -fno-omit-frame-pointer -I../.. -I../../../.. -I../../../lib -o tmem ../_string.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c  ../malloc.c tmem.c -Wl,-lX11 -pthread
#$CC $CCWARNFLAGS -msse2 -DPTHREAD=1 -DX11VIS=1 -D_REENTRANT -g -Wall -fno-builtin -O -fno-omit-frame-pointer -I../../../.. -I../../../lib /../include -o xheap heap.c ../stdlib/../../zero/priolk.c ../../zero/lfdeq.c  ../malloc.c -pthread -lX11
...
$CC $CCWARNFLAGS -msse2 -DX11VIS=0 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DDEVEL=0 -g -Wall -fno-builtin -shared -fPIC -O -fno-omit-frame-pointer -I../../../.. -I../../../lib -fPIC -shared -o zmalloc.so -I../.. ../_string.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c ../malloc.c -pthread
