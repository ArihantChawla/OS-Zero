...
CC=gcc
CCOPTFLAGS="-msse2 -O0 -fno-builtin -fno-tree-loop-distribute-patterns -fno-omit-frame-pointer"
...
##$CC $CCOPTFLAGS $CCWARNFLAGS -DX11VIS=0 -DMALLOCTRACE=1 -DMALLOCSTAT=0 -DMALLOCHASHSTAT=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -g -Wall -I../../../.. -I../../../lib -o tzheap heap.c ../execinfo.c ../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c  ../malloc.c -pthread
$CC $CCOPTFLAGS $CCWARNFLAGS -DMALLOCSTAT=0 -DMALLOCHASHSTAT=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -I../.. -I../../../.. -I../../../lib -o xzheap ../string.c heap.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c  ../malloc.c -Wl,-lX11 -pthread
$CC $CCOPTFLAGS $CCWARNFLAGS -DMALLOCSTAT=0 -DMALLOCHASHSTAT=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -I../.. -I../../../.. -I../../../lib -o t-test1 ../string.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c  ../malloc.c t-test1.c -Wl,-lX11 -pthread
$CC $CCOPTFLAGS $CCWARNFLAGS -DMALLOCSTAT=0 -DMALLOCHASHSTAT=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -I../.. -I../../../.. -I../../../lib -o tmem ../string.c ../../zero/hash64.c ../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c  ../malloc.c tmem.c -Wl,-lX11 -pthread
#$CC $CCOPTFLAGS $CCWARNFLAGS -DPTHREAD=1 -DX11VIS=1 -D_REENTRANT -g -Wall -I../../../.. -I../../../lib /../include -o xheap heap.c ../stdlib/../../zero/priolk.c ../../zero/lfdeq.c ../../zero/hash32.c  ../malloc.c -pthread -lX11
