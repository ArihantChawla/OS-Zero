...
$CC -DPTHREAD=1 -D_REENTRANT -g -Wall -O -I. -o heap heap.c -pthread
$CC -DPTHREAD=1 -pg -D_ZERO_SOURCE=1 -D_REENTRANT -g -Wall -O0 -I../.. -o zheap heap.c ../malloc.c -pthread
$CC -DPTHREAD=1 -D_ZERO_SOURCE=1 -D_REENTRANT -DX11VIS=1 -g -Wall -O -I../.. -o xzheap heap.c ../malloc.c -Wl,-lX11 -pthread
