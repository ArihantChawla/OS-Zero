...
$CC $CCWARNFLAGS -DMALLOCMULTITAB=1 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -g -Wall -fno-builtin -O0 -I. -o heap heap.c -pthread
$CC $CCWARNFLAGS -DX11VIS=0 -DMALLOCMULTITAB=1 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -g -Wall -fno-builtin -O0 -I../../../.. -I../../../lib -o zheap heap.c ../malloc.c -pthread
$CC $CCWARNFLAGS -DMALLOCMULTITAB=1 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DX11VIS=1 -g -Wall -fno-builtin -O0 -I../../../.. -I../../../lib -o xzheap heap.c ../malloc.c -Wl,-lX11 -pthread
...
$CC $CCWARNFLAGS -DX11VIS=0 -DMALLOCMULTITAB=1 -DZEROHASH=0 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DDEVEL=0 -g -Wall -fno-builtin -O0 -I../../../.. -I../../../lib -fPIC -shared -o zmalloc.so ../malloc.c -pthread
