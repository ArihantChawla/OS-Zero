...
CCOPTFLAGS="-O0 -DZERONEWFMTX=1 -DMEMBKTLOCK=0 -DMEMSPINBITLOCK=0 -fno-builtin -DMEMBLKHDR=0 -DMEMSIGNAL=0 -DMEMBIGHASH=0 -DMEMSTAT=1 -DMEMBUFDEBUG=0 -DMEMHASHSUBTABS=0 -DMEMBIGPAGES=0 -DMEMUNMAP=1 -DMEMEMPTYTLS=1 -DMEMDEADBINS=0 -DMEMCACHECOLOR=1 -DMEMBUFSTACK=1 -DMEMBUFRELMAP=0 -DMEMNEWHASHTAB=0 -DMEMNOSBRK=1 -DGNUMALLOC=0 -DMEMHASHMURMUR=0 -DMEMHASHNREF=0 -DMEMHASHNACT=0 -DMEMDEBUGDEADLOCK=1 -DMEMMULTITAB=0 -DMEMTINYHASHTAB=0 -DMEMSMALLHASHTAB=0 -DMEMHUGEHASHTAB=0 -DMEMBIGHASHTAB=1 -DMEMNEWHASH=1 -DMEMBITFIELD=0 -DMEMDEBUG=0 -DMEMDEBUGLOCK=0 -DMEMTEST=0 -DMEMTESTSTACK=0 -DMEMVALGRIND=1 -finline-functions -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-free -fno-builtin-realloc -fno-builtin-memalign"
