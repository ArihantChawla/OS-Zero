...
$CC -DMALLOCMULTITAB=1 -DZEROHASH=1 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -pg -D_REENTRANT -g -Wall -fno-builtin -O0 -I../../../.. -I../../../lib -o zheap heap.c ../malloc.c -pthread
...
$CC -DMALLOCMULTITAB=1 -DZEROHASH=1 -DZEROFUTEX=0 -DZEROMALLOC=1 -DPTHREAD=1 -D_REENTRANT -DDEVEL=0 -g -Wall -fno-builtin -O -I../../../.. -I../../../lib -fPIC -shared -o zmalloc.so ../malloc.c -pthread
