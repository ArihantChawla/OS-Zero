...
#if (USEXOPEN2K)
extern int clock_nanosleep(clockid_t clk, int flg, const struct timespec *req,
...
#endif
#if (USEXOPENEXT)
#define GETDATE_DATEMASK_INVAL 1	// environment variable DATEMSK is null or undefined
#define GETDATE_CANNOT_READ    2    // template file cannot be opened for reading
...
#define GETDATE_NO_TEMPL       7    // no line in template matches input_iterator
...
#endif
#if (_GNU_SOURCE)
extern getdate_r(const char *__restrict str, struct tm *__restrict res);
#endif
