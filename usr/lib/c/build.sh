...
$CC $CCWARNFLAGS -DNVALGRIND -DZERONEWMTX=0 -DZEROMALLOC=0 -DPTHREAD=1 -D_REENTRANT -g -O -I/usr/include -I. -I.. -I../m -I../../.. -I../../../usr/lib -fPIC -fno-builtin -shared -o zlibc.so *.c bits/*.c sys/*.c sys/zero/*.c x86-64/*.S -pthread
