...
\chapter{Notes}
	...
	bytecode before execution. This bytecode is then handled to the
	pseudo machine (\textbf{wpm}) to be executed.
...
\subsection{Instructions and Flags}
...
\begin{tabular}
	...
	PALLOC	& size & N/A & allocate size bytes of dynamic memory \\
...
\end{verbatim}
	...
	Standard I/O is done as byte streams; for example, you can write a
	character on the user's terminal with
