...
$CC -DWPM_VC=1 -DZAS32BIT=1 -DZASBUF=0 -DZASMMAP=1 -DZASPROF=1 -DWPM=1 -I.. -I../../lib -O0 -g -Wall -o wpm ../zas/zas.c expr.c wpm.c vc.c mem.c ../vcode/vc.c ../vcode/op.c -pthread -lm
