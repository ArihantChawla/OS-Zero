...
$CC -DWPMMMU=1 -DZAS32BIT=1 -DZASBUF=0 -DZASMMAP=1 -DZASPROF=1 -DWPM=1 -I.. -I../../lib -O -g -Wall -o wpm ../zas/zas.c ../zas/mach.c expr.c wpm.c mem.c ../../lib/vec/vec.c ../../lib/vec/vm.c ../../lib/vec/op.c -pthread -lm
