...
// dest -= src, set carry-bit
#define v0sbcop(src, dest, res, flg)                                    \
    do {                                                                \
        v0ureg _usrc = (src);                                           \
        v0ureg _udest = (dest);                                         \
                                                                        \
