...
static struct op       * zasgetinst(uint8_t *str, uint8_t **retptr);
...
static struct zassym *symhash[NHASHITEM];
...
zastranslate(zasmemadr_t base)
{
    ...
    struct zastoken *token = tokenqueue;
    tokfunc_t       *func;
